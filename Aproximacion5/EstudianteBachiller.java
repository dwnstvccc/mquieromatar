...
/**
 * Write a description of class Ingeniero here.
 * 
 * @author (your name) 
...
public class EstudianteBachiller{
    ...
    public void setLibrostres(double librostres){
        if(librosdos >= 0) this.librostres = librostres;
        else this.librostres = 0;
    }
    
    EstudianteBachiller(String id, String nombre, String tiempo, double librosuno, double librosdos, double librostres){
